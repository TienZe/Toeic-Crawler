...
def crawl_part2(input_file_path, output_path):
    # Mở và đọc file HTML
    ...
    for i, (audio_div, transcript_div) in enumerate(zip(audio_sources,  transcripts)):
        ...
        if collapse_div:
            transcript_html = collapse_div.decode_contents().strip()  # Lấy nội dung bên trong
        ...
        for j in range(1):
            ...
            if question_index < len(question_wrappers):
                ...
                if explanation_wrapper:
                    ...
                    if collapse_div:
                        explain_html = collapse_div.decode_contents().strip()  # Lấy nội dung giải thích
...
if __name__ == "__main__":
    crawl_part2('text/2021_2/part2.txt', 'part2.json')
